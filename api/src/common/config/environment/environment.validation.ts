...
const environmentSchema = z
  .object({
    ...
    APP_CORS_ORIGIN: crossOriginSchema,
    ...
    AUTH_REFRESH_TOKEN_TTL_SECONDS: z.coerce.number().min(1),
    AUTH_SESSION_ABSOLUTE_TTL_SECONDS: z.coerce.number().min(1),
  })
